  ...
  return (
    <>
      <style>{`
        ...
        @keyframes bd3ov-shimmer {
          0%   { background-position: -200% 0; }
          100% { background-position:  200% 0; }
        }
        @keyframes bd3ov-fadein  { from { opacity: 0; } to { opacity: 1; } }
        @keyframes bd3ov-fadeout { from { opacity: 1; } to { opacity: 0; } }
        ...
        .bd3ov-backdrop.visible {
          opacity: 1;
          pointer-events: all;
          animation: bd3ov-fadein 0.35s ease forwards;
        }
        ...
        .bd3ov-spinner {
          position: relative; width: 110px; height: 110px; z-index: 1;
          display: flex; align-items: center; justify-content: center;
        }
        .bd3ov-track {
        ...
        .bd3ov-sub {
          ...
          animation: bd3ov-shimmer 2.2s linear infinite;
          margin: -10px 0 0;
        }
      `}</style>
      ...
      <div className={`bd3ov-backdrop${isVisible ? " visible" : ""}`}>
        <div className="bd3ov-card">
          ...
          <p className="bd3ov-sub">
            {icon === "download"
              ? "Rendering your HD 1080 × 1350 image"
