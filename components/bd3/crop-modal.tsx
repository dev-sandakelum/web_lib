...
export const CropModal3: React.FC<CropModalProps> = ({ imageUrl, initialTransform, onSave, onClose }) => {
  ...
  const renderCanvas = () => {
    ...
    grad.addColorStop(0.5, "rgba(192,38,211,0.9)");
    ...
    <>
      <style>{`
        ...
        .bd3-modal-card {
          ...
          box-shadow: 0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.04), 0 0 60px rgba(124,58,237,0.08);
        ...
        .bd3-modal-icon {
          ...
          background: linear-gradient(135deg, rgba(124,58,237,0.3), rgba(192,38,211,0.3));
          border: 1px solid rgba(124,58,237,0.3);
          display: flex; align-items: center; justify-content: center;
        }
        .bd3-modal-title { font-size: 14px; font-weight: 700; color: #f1f1f8; letter-spacing: -0.2px; }
        .bd3-modal-subtitle { font-size: 11px; color: rgba(255,255,255,0.3); margin-top: 1px; }
        .bd3-modal-close {
        ...
        .bd3-modal-close:hover { background: rgba(255,255,255,0.1); color: #fff; }
        ...
        .bd3-canvas-hint {
          ...
          font-size: 10.5px; color: rgba(255,255,255,0.35); white-space: nowrap;
          pointer-events: none;
        }
        ...
        .bd3-zoom-label { font-size: 10.5px; font-weight: 600; color: rgba(255,255,255,0.3); letter-spacing: 0.06em; }
        .bd3-slider {
        ...
        .bd3-slider::-webkit-slider-thumb {
          ...
          box-shadow: 0 0 0 3px rgba(124,58,237,0.25), 0 2px 6px rgba(0,0,0,0.4);
          cursor: grab; transition: box-shadow 0.15s;
        }
        .bd3-slider::-webkit-slider-thumb:active { cursor: grabbing; box-shadow: 0 0 0 5px rgba(124,58,237,0.3); }
        .bd3-slider::-moz-range-thumb {
          width: 16px; height: 16px; border-radius: 50%; background: #7c3aed;
          border: none; box-shadow: 0 0 0 3px rgba(124,58,237,0.25); cursor: grab;
        }

        .bd3-transform-btns { display: flex; align-items: center; gap: 8px; }
        .bd3-transform-label { font-size: 10.5px; font-weight: 600; color: rgba(255,255,255,0.3); letter-spacing: 0.06em; margin-right: 4px; }
        .bd3-tbtn {
          display: flex; align-items: center; justify-content: center;
        ...
        .bd3-tbtn:hover { border-color: rgba(255,255,255,0.22); background: rgba(255,255,255,0.09); color: #fff; }
        .bd3-tbtn.active { border-color: rgba(124,58,237,0.6); background: rgba(124,58,237,0.12); color: #a78bfa; }
        ...
        .bd3-modal-reset:hover { color: rgba(255,255,255,0.85); border-color: rgba(255,255,255,0.2); background: rgba(255,255,255,0.08); }
        .bd3-modal-apply {
        ...
        .bd3-modal-apply:hover { opacity: 0.9; transform: translateY(-1px); box-shadow: 0 6px 22px rgba(124,58,237,0.45); }
        ...
        <div className="bd3-modal-card">
          ...
          <div className="bd3-controls">
            ...
            <div className="bd3-zoom-row">
              <ZoomOut size={15} color="rgba(255,255,255,0.3)" />
              <input
              ...
              />
              <ZoomIn size={15} color="rgba(255,255,255,0.3)" />
              <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", minWidth: 34, textAlign: "right", fontVariantNumeric: "tabular-nums" }}>
