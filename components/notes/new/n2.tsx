  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-5xl mx-auto px-1 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        The requested content is presented below, maintaining the structure and formatting defined in the original code, but replacing the internal class names and JSX components with appropriate Markdown for visual structure (Headings, Blockquotes, Lists, and Tables).
          ...
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 leading-relaxed mb-3">
                ...
                links. A network can be defined as two or more computers/nodes
              ...
              <HighlightBox color="blue">
                ...
                <p>
                  A set of systems/nodes interconnected by communication links
                  that is primarily used for information transfer (information =
                  messages/data from applications)
                </p>
                <ul className="list-disc ml-5 mt-2 space-y-1">
                  <li>
                    <strong>Systems:</strong> Computers and other end systems
                    (tablets, smartphones, sensors), switches, routers
                  </li>
                  <li>
                    <strong>Links:</strong> Wired (twisted pair, Twinax, coaxial
                    cable, optical fiber)
                  </li>
                </ul>
              </HighlightBox>
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                <li>
                  Before computer networks, people sent and received information
                  by hand, using the postal service. This is slow and can be
                  unreliable.
                </li>
                <li>
                ...
                <li>
                  Computer networks and the sharing of electronic data
                  encourages the use of standard policies and procedures.
                </li>
                <li>
                  Computer networks provide backup and recovery support for our
                  data redundancy.
                </li>
            ...
            <SectionCard>
              ...
              <Subsection title="1️⃣ Business Applications">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    A client is a program requesting services. Services is a
              ...
              <Subsection title="4️⃣ Social Issues">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Many problems could be solved if the computer security is
                    taken seriously.
                  </li>
                </ul>
              </Subsection>
            ...
            <SectionCard>
              ...
              <Subsection title="📡 Broadcast Links">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Broadcasting:</strong> A packet transmitted is
                    received by every machine.
                  </li>
                  <li>
                    <strong>Multicasting:</strong> Transmission to a subset of
                    the machines.
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="🔗 Point-to-Point Links">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Point-to-point transmission with one sender and receiver is
            ...
            <SectionCard>
              ...
              <HighlightBox title="Characteristics:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Size:</strong> Restricted to particular geographic
                    region (office building, single department)
                  </li>
                  <li>
                    <strong>Transmission Technology:</strong> 10 Mbps to 10 Gbps
                  </li>
                  <li>
                    <strong>Topology:</strong> bus, star and ring
                  </li>
                  <li>Usually a privately owned network</li>
                </ul>
              </HighlightBox>

              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2 mt-4">
                LAN Topologies:
              </h3>
              ...
              <Subsection title="⭕ Ring Topology">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    ...
                    in a circle creating a unidirectional path.
                  </li>
                  <li>
                    No need of server to control the connectivity among the
                    nodes.
                  </li>
                  <li>
                    Each entity participating in the ring reads a message, then
                    regenerates it and hands it to its neighbor.
                  </li>
                  <li>The ring makes it difficult to add new computers.</li>
                  <li>
                    Unlike a star topology network, the ring topology network
                    will go down if one entity is removed.
                  </li>
                  <li>Minimum collision (in single ring)</li>
                  <li>
                    <strong>Single ring:</strong> All devices share a single
                    cable
                  </li>
                  <li>
                    <strong>Dual ring:</strong> Data can be sent in both
                    directions
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="🚌 Bus Topology">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Simplest physical topology consisting of a single cable that
                    runs to every workstation
                  </li>
                  <li>
                    Uses the least amount of cabling, but covers the shortest
                    distance
                  </li>
                  <li>Each computer shares the same data and address path</li>
                  <li>
                    Messages pass through the trunk, and each workstation checks
                    if the message is addressed to itself
                  </li>
              ...
              <Subsection title="⭐ Star Topology">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Branches each network device off a central device called a
                    hub
                  </li>
                  <li>Very easy to add a new workstation</li>
                  <li>
                    If any workstation goes down, it does not affect the entire
                    network
                  </li>
                  <li>
                    If the central device goes down, the entire network goes
                    down
                  </li>
                  <li>Resembles spokes in a bicycle wheel</li>
                  <li>
                    Easy to install - cable is run from each workstation to the
                    hub
                  </li>
                  <li>
                    More expensive to install than bus networks due to more
                    cables and hubs needed
                  </li>
                </ul>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                <li>
                  Computer network larger than a LAN and connects clients and
                  servers from multiple buildings over a larger area.
                </li>
                <li>
                  A MAN may use different transmission technology and different
                  media, such as fiber and wireless because of the greater
                  distance it covers.
                </li>
                <li>Utilized across multiple buildings.</li>
                <li>
                  Commonly used in school campuses or large companies with
                  multiple buildings.
                </li>
                <li>Larger than a LAN, but smaller than a WAN.</li>
                <li>
                  Also used to mean the interconnection of several LANs by
                  bridging them together (campus network).
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                A Wide Area Network is a computer network that covers a broad
              ...
              <Subsection title="📶 Wireless WAN">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    A wide area network where separate areas of coverage or
                    cells are connected wirelessly to provide service to a large
                    geographic area.
                  </li>
                  <li>
                    WWANs make use of technologies that focus on modulation of
                    voice and data.
                  </li>
                  <li>
                    Exclusively use Radio Frequency signals designed to
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-1 text-xs sm:text-sm text-gray-700">
                <li>
                  <strong>Computers:</strong> Desktop PC, notebook PC, PDA,
                  shared peripherals
                </li>
                <li>
                  <strong>Telecommunications:</strong> Telephone, Mobile
                  telephone, intercom, fax
                </li>
                <li>
                  <strong>Appliances:</strong> Microwave, refrigerator, clock,
                  furnace, airco, lights, AC
                </li>
                <li>
                  <strong>Telemetry:</strong> Utility meter, smoke/burglar
                  alarm, thermostat, babycam
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                internetwork or internet. Internetworking devices are products
            ...
            <SectionCard>
              ...
              <Subsection title="📋 Functions of Network Software">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    ...
                    network from data breaches, unauthorized access and attacks
                  </li>
              ...
              <Subsection title="🏗️ Protocol Hierarchies">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Layer n protocol:</strong> Rules and conventions for
                    this communication.
                  </li>
                  <li>
                    The entities on each host implementing the layer n protocol
                    are peers.
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="🎯 Design Issues for the Layers">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Addressing:</strong> Some form of addressing is
                    needed to specify a specific destination.
                  </li>
                  <li>
                    <strong>Rules for data transfer:</strong> Simplex,
                    Half-duplex and full duplex transmission.
                  </li>
                  <li>
                    <strong>Error control:</strong> Both ends must agree on
                    error detecting and correcting codes.
                  </li>
                  <li>
                    <strong>Sequencing and reassembly:</strong> Messages may
                    arrive out of order and need proper reassembly.
                  </li>
                  <li>
                    <strong>Flow control:</strong> Need to regulate flow of data
                    to avoid swamping receiver.
                  </li>
                  <li>
                    <strong>Message size handling:</strong> Disassembling,
                    transmitting and reassembling messages.
                  </li>
                  <li>
                    <strong>Routing:</strong> Choosing a path when there are
            ...
            <SectionCard>
              ...
              <HighlightBox color="purple">
                <p className="mb-2">
                  <strong>Service:</strong> A set of primitives (operations)
                  that a layer provides to the layer above it.
                </p>
                <p>
                  <strong>Protocol:</strong> A set of rules governing the format
                  and meaning of the frames, packets, or messages that are
                  exchanged by the peer entities within layer.
                </p>
              </HighlightBox>
            </SectionCard>
          </div>
        ...
        {activeSection === "reference" && (
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Network architecture refers to the way a network is designed and
                built. The two major types are:
              </p>

              <Subsection title="👥 Peer-to-Peer Architecture">
                <p className="mb-2">
                  Computers connect with each other in a workgroup to share
                  files, printers, and Internet access. This is used to connect
              ...
              <Subsection title="🖥️ Client-Server Architecture">
                <p className="mb-2">
                  Sends information from a client computer to a server, which
                  then relays the information back to the client's computer, or
                ...
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Enhance security - only administrators have access to Server
                  </li>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                In 1947, the International Standard Organization (ISO) is a
                multinational body dedicated to worldwide agreement on
                international standards. In late 1970s, an open system is a set
                of protocols that allow any two different systems to
                communicate.
              </p>
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                It divides the communications process into seven layers. Each
                communicating user or program is at a computer that can provide
                those seven layers of function.
              </p>

              <HighlightBox
                title="7 Layers of OSI Model (Top to Bottom):"
                color="blue"
              >
              ...
              <Subsection title="7️⃣ Application Layer">
                <p className="mb-2">
                  Responsible for providing services to the user and enable
                ...
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>HTTP:</strong> Hypertext Transfer Protocol - basis
                    for World Wide Web
                  </li>
                  <li>
                    Other protocols: File transfer, electronic mail, and network
                    news
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="5️⃣ Session Layer">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Establishes, manages, and synchronizes the connections
              ...
              <Subsection title="4️⃣ Transport Layer">
                <p className="mb-2">
                  Purpose: Provide a reliable mechanism for the exchange of data
              ...
              <Subsection title="1️⃣ Physical Layer">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Major function: Move data in the form of electromagnetic
                    signals across a transmission medium
                  </li>
                  <li>
                    Responsible for movements of individual bits from one Node
                    to next
                  </li>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                layers built upon the hardware. TCP/IP was developed earlier
                than the OSI 7-layer model, so it does not have 7 layers but
                only 4 layers.
              </p>

              <HighlightBox
                title="4 Layers of TCP/IP Model (Top to Bottom):"
                color="blue"
              >
                <ol className="list-decimal ml-5 space-y-1">
                  <li>Application Layer</li>
              ...
              <Subsection title="4️⃣ Application Layer">
                ...
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>TELNET:</strong> Two-way communication protocol that
                    allows connecting to a remote machine and run applications
                    on it
                  </li>
                  <li>
                    <strong>FTP (File Transfer Protocol):</strong> Allows file
                    transfer amongst computer users connected over a network.
                    Reliable, simple, and efficient
                  </li>
                  <li>
                    <strong>SMTP (Simple Mail Transport Protocol):</strong> Used
                    to transport electronic mail between source and destination,
                    directed via a route
                  </li>
                  <li>
                    <strong>DNS (Domain Name Server):</strong> Resolves an IP
                    address into a textual address for Hosts connected over a
                    network
                  </li>
              ...
              <Subsection title="3️⃣ Transport Layer">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Decides if data transmission should be on parallel path or
                    single path
                  </li>
                  <li>
                  ...
                  <li>
                    Breaks the message (data) into small units for efficient
                    handling by network layer
                  </li>
              ...
              <Subsection title="2️⃣ Internet Layer">
                <p className="mb-2">
                  ...
                  connectionless internetwork layer. It is the layer which holds
              ...
              <Subsection title="1️⃣ Host-to-Network Layer">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    TCP/IP does not define any specific protocol at this layer
                  </li>
                  <li>Supports all standard and proprietary protocols</li>
                  <li>
                    Protocol is used to connect to the host, so that packets can
                    be sent over it
                  </li>
                  <li>Varies from host to host and network to network</li>
                  <li>
                    A network in TCP/IP internetwork can be a local-area network
        ...
        {activeSection === "ip" && (
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                IP address is short for Internet Protocol Address. IP is a
                network layer - it must be capable of providing communication
                between hosts on different kinds of networks.
              </p>

              <HighlightBox color="blue">
                <p className="mb-2">
                  The address must include information about what network the
                  receiving host is on.
                </p>
                <p className="mb-2">
                  <strong>IP address helps to identify:</strong>
                </p>
                <ul className="list-disc ml-5 space-y-1">
                  <li>Name</li>
                  <li>Location</li>
                ...
                <p className="mt-2">
                  It is a unique identifier that allows transfers of files and
                  e-mail between two computers located at different places.
                </p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="IPv6">
                <p>
                  Next generation IP addressing (covered in advanced topics)
                </p>
              </Subsection>
            ...
            <SectionCard>
              ...
              <ExampleBox>
                ...
                <p className="mb-1">
                  Change the following IP address from dotted-decimal notation
                  to binary notation:
                </p>
              ...
              <ExampleBox>
                ...
                <p className="font-semibold">Solution:</p>
                <p>
                  In decimal notation each number ≤ 255, 301 is out of the range
                </p>
              </ExampleBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="Class A">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Range:</strong> 0.0.0.0 to 127.255.255.255
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="Class B">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Range:</strong> 128.0.0.0 to 191.255.255.255
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="Class C">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Range:</strong> 192.0.0.0 to 223.255.255.255
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="Class D">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Range:</strong> 224.0.0.0 to 239.255.255.255
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="Class E">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Range:</strong> 240.0.0.0 to 255.255.255.255
                  </li>
                </ul>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <ExampleBox>
                <p className="font-semibold mb-2">
                  Example 1: Find class in Binary Notation
                </p>
              ...
              <ExampleBox>
                <p className="font-semibold mb-2">
                  Example 2: Find class in Binary Notation
                </p>
              ...
              <ExampleBox>
                <p className="font-semibold mb-2">
                  Example 3: Find class in Decimal Notation
                </p>
              ...
              <ExampleBox>
                <p className="font-semibold mb-2">
                  Example 4: Find class in Decimal Notation
                </p>
            ...
            <SectionCard>
              ...
              <HighlightBox
                title="32-bit Binary Number 'Subnet Mask':"
                color="blue"
              >
                <ul className="list-disc ml-5 space-y-1">
              ...
              <ExampleBox>
                <p className="font-semibold mb-2">
                  Example: IP address = 192.168.2.25
                </p>
                <p className="mb-1">
                  All 1 bits (left to right) identify network/subnet
                </p>
                <p className="mb-1">Remaining 0 bits identify host/interface</p>
                <p className="font-mono mt-2 mb-1">
                  192.168.10.79 with subnet mask 255.255.255.240
                </p>
            ...
            <SectionCard>
              ...
              <HighlightBox
                title="Practice Example 1: Find Subnet Mask"
                color="yellow"
              >
                <ul className="list-disc ml-5 space-y-1">
                  <li>10.72.8.0/22</li>
              ...
              <HighlightBox
                title="Practice Example 2: Find CIDR Notation"
                color="yellow"
              >
                <ul className="list-disc ml-5 space-y-1">
              ...
              <HighlightBox
                title="Practice Example 3: Find Network Details"
                color="yellow"
              >
                <p className="mb-2">
                  Find the network id, subnet mask, starting and ending address,
          ...
          <div>
            <SectionCard>
              ...
              <Subsection title="📊 Fourier Analysis">
                <p className="mb-2">
                  ...
                  Jean-Baptiste Fourier proved that any reasonably behaved
              ...
              <Subsection title="📈 Bandwidth-Limited Signals">
                ...
                <p className="mb-2">
                  <strong>Maximum data rate = 2H log₂ V bits per second</strong>
                </p>
                <ul className="list-disc ml-5 space-y-1">
                  <li>H = frequency</li>
                ...
                <h5 className="font-semibold mt-3 mb-2">
                  Shannon's Theorem (with noise):
                </h5>
                <p className="mb-2">
                  The amount of thermal noise present is measured by the ratio
                  of the signal power to the noise power, called the SNR
                  (Signal-to-Noise Ratio)
                </p>
                <p className="mb-2">
                  <strong>SNR = (Power of signal) / (power of noise)</strong>
                </p>
                <p className="mb-2">
                  <strong>Maximum data rate = H log₂ (1 + S/N) bps</strong>
                </p>
            ...
            <SectionCard>
              ...
              <ExampleBox>
                ...
                <p>
                  Consider a noiseless channel with a bandwidth of 4000 Hz
                  transmitting a signal with four signal levels. What can be the
                  maximum bit rate?
                </p>
              </ExampleBox>
              ...
              <ExampleBox>
                ...
                <p>
                  ...
                  bandwidth of 40 kHz. How many signal levels do we need?
                </p>
              </ExampleBox>
              ...
              <ExampleBox>
                ...
                <p>
                  ...
                  2047. What will be the capacity for this channel?
                </p>
              </ExampleBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                In a data transmission system, the transmission media is the
                physical path between transmitter and receiver. Transmission
                media are actually located below the physical layer and are
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                A twisted pair cable consist of two conductor (normally copper),
                each with its own plastic insulation, twisted together. The
                purpose of twisted pair cable is to remove or cancel out
              ...
              <Subsection title="🔌 Unshielded Twisted Pair (UTP) Cable">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    No shield provided - only two twisted copper wires with
                    their own color plastic insulator
                  </li>
                  <li>Very cheap and easy to install</li>
                  <li>Badly affected by noise interference</li>
                  <li>
                    <strong>Data Rate:</strong> 10-100 Mbps
                  </li>
                  <li>
                    <strong>Cable Length:</strong> 100 meter max
                  </li>
                  <li>
                    <strong>Electrical Interface:</strong> Most interference and
                    cross talk occurs
                  </li>
                  <li>
                    <strong>Installation:</strong> Easy to install
                  </li>
                  <li>
              ...
              <Subsection title="🛡️ Shielded Twisted Pair (STP) Cable">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Has a metal foil to cover each pair of insulating conductors
                  </li>
                  <li>
                    Reduces the interference of the noise but makes the cable
                    bulky and expensive
                  </li>
                  <li>
                    <strong>Data Rate:</strong> 150 Mbps
                  </li>
                  <li>
                    <strong>Cable Length:</strong> 500 meter max
                  </li>
                  <li>
                    <strong>Electrical Interface:</strong> Less interference and
                    cross talk occurs
                  </li>
                  <li>
                    <strong>Installation:</strong> Very easy to install
                  </li>
                  <li>
                    <strong>Cost:</strong> Little costly
                  </li>
                </ul>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="✅ Features & Applications">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Braided mesh helps prevent signal interference or cross-talk
                  </li>
                  <li>
                    Cross-talk: Signal from one cable becomes mixed with signal
                    in different cable
                  </li>
                  <li>
                    <strong>Applications:</strong> Cable TV, LANs
                  </li>
                </ul>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="🔬 Optical Fiber Layers">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Core:</strong> Made of high quality silica glass or
                    plastic
                  </li>
                  <li>
                    <strong>Cladding:</strong> Made of high quality silica glass
                    or plastic, with a lower refractive index than the core
                  </li>
                  <li>
                    <strong>Buffer:</strong> Protective outer covering
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="📡 Features">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Single node fiber optic cable:</strong> Maximum
                    segment length of 2 km, bandwidth up to 100 Mbps
                  </li>
                  <li>
                    <strong>Multi-node fiber optic cable:</strong> Maximum
                    segment length of 100 km, bandwidth up to 2 Gbps
                  </li>
                </ul>
              </Subsection>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                to as wireless communication. Signals are normally broadcast
              ...
              <Subsection title="🌍 Ground Propagation">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Applications:</strong> Television signal
                    broadcasting, target detection for military purposes, radio
                    signal transmission, local range operations
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="☁️ Sky Propagation">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    <strong>Applications:</strong> Radar and satellite
                    communication, television broadcasting, line-of-sight
                    communication, mobile communications
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="📡 Line of Sight Propagation">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Very high-frequency signals transmitted in straight lines
            ...
            <SectionCard>
              ...
              <Subsection title="📻 Radio Waves">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Use omnidirectional antennas that send out signals in all
                    directions
                  </li>
                  <li>
                    Omnidirectional characteristics make them useful for
                    multicasting (one sender, many receivers)
                  </li>
                  <li>
                    <strong>Range:</strong> Between 3 kHz to 1 GHz
                  </li>
                  <li>
                    <strong>Examples:</strong> AM, FM radio, television
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="📡 Microwaves Transmission">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Electromagnetic waves having frequencies between 1 to 300
                    GHz
                  </li>
                  <li>
                    Microwaves are unidirectional (operating or moving in one
                    direction only)
                  </li>
                  <li>
                    When an antenna transmits microwaves, they can be narrow
                    focused
                  </li>
              ...
              <Subsection title="🔴 Infrared Transmission">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Advantageous: Prevents interference between one system and
                    another
                  </li>
                  <li>
                    A short-range system in one room cannot be affected by
                    another system in the next room
                  </li>
                  <li>
                    <strong>Example:</strong> When we use our infrared remote
                    control, we don't interfere with the use of the remote by
                    our neighbors
                  </li>
                </ul>
              </Subsection>
        ...
        {activeSection === "multiplexing" && (
          <div>
            <SectionCard>
              ...
              <HighlightBox color="blue">
                <p className="mb-2">
                  <strong>Multiplexer (MUX):</strong> Device that combines n
                  input lines to generate one output line (many to one)
                </p>
                <p>
                  <strong>Demultiplexer (DEMUX):</strong> Device used at
                  receiving end that separates signal into its component signals
                  (one to many)
                </p>
              </HighlightBox>
            </SectionCard>
              ...
              <Subsection title="📊 Features">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    ...
                    composite signal and transmitted on a single link
                  </li>
                  <li>
            ...
            <SectionCard>
              ...
              <Subsection title="💡 Features">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Different signals are optical or light signals that are
                    transmitted through optical fiber
                  </li>
                  <li>
                    Various light waves from different sources are combined to
                    form a composite light signal transmitted across the channel
                    to the receiver
                  </li>
                  <li>
                    At receiver side, this composite light is broken into
                    different light waves by Demultiplexer
                  </li>
                  <li>
                    Combining and splitting of light waves are done by using a
                    PRISM
                  </li>
                  <li>
                    Prism bends beam of light based on the angle of incidence
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                various equipment and interconnecting facilities that provide
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                multitude of sophisticated phone features, data services, and
              ...
              <HighlightBox title="PSTN Components:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Undergraduate Lines (UG):</strong> Underground
                    telephone cables
                  </li>
                  <li>
                    <strong>Overhead Lines (OH):</strong> Above-ground telephone
                    lines
                  </li>
                </ul>
              </HighlightBox>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                DSL (Digital Subscriber Line) is the general term for services
                that offer internet connections via a digital modem and a copper
                telephone line. The beauty of DSL is that there is one superfast
                internet connection.
              </p>
              ...
              <HighlightBox title="Types of DSL:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>SDSL:</strong> Symmetric Digital Subscriber Line
                  </li>
                  <li>
                    <strong>VDSL:</strong> Very High Speed Digital Subscriber
                    Line
                  </li>
                  <li>
                    <strong>ADSL:</strong> Asymmetric Digital Subscriber Line
                  </li>
                </ul>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="📏 Distance vs Bandwidth">
                <p className="mb-2">
                  ADSL performance depends on distance from the telephone
                  exchange:
                </p>
                <ul className="list-disc ml-5 space-y-1">
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                connection. It converts an analog signal to a digital signal for
                the purpose of granting access to broadband Internet.
              </p>
        ...
        {activeSection === "datalink" && (
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                The Data Link Layer handles communication between adjacent network nodes and provides services to the Network Layer.
              </p>

              <HighlightBox title="Data Link Layer Design Issues:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                ...
                <table className="w-full text-xs sm:text-sm border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-gray-300 p-2">
                        Used when error rate is low. No connection establishment. Sends independent frames. No acknowledgement. No flow control. No error control.
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-2 font-semibold">
                      ...
                      <td className="border border-gray-300 p-2">
                        Provides acknowledgment without establishing a connection
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-2 font-semibold">
                      ...
                      <td className="border border-gray-300 p-2">
                        Connection establishment. Each frame is numbered. Frames delivered in serial order. Acknowledgement. Guarantees that all frames received. Flow control. Error control. Protocols: HTTP, FTP, SMTP
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700">
                With the error control process, we can be confident that the transmitted and received data are identical. Data can be corrupted during transmission. For reliable communication, error must be detected and corrected.
              </p>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <HighlightBox title="Frame Structure:" color="green">
                <p className="mb-2"><strong>Header:</strong> Frame starting bits, Address of the source or destination, Type of data, Quality control</p>
                <p className="mb-2"><strong>Payload:</strong> Actual data</p>
                <p><strong>Trailer:</strong> Frame stopping bits, Error detection</p>
              </HighlightBox>

              <HighlightBox title="Framing Methods:" color="yellow">
                <p className="mb-2">Break down a stream of bits into smaller, digestible chunks called frames. How can frame be transmitted so the receiver can detect frame boundaries?</p>
                <ul className="list-disc ml-5">
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Here a field in the header, Specifies the number of characters in the frame. The Data Link Layer at the destination looks at the character count and decides the end of the frame.
              </p>
              <HighlightBox color="red">
                <p><strong>Drawback:</strong> If any count is garbled by a transmission error, then the destination is unable to decide the frames.</p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Each frame start and end with special bytes – Flag Bytes. If the flag bytes occurs in the frame, stuff an extra Escape byte (ESC).
              </p>
              
              <HighlightBox color="blue">
                <p className="mb-2">A serious problem occurs when binary data itself will contain flag byte's bit pattern. This situation will usually interfere with framing.</p>
                <p className="mb-2">One solution is Flag Byte Stuffing where sender's data link layer insert a special escape byte (ESC) just before each "accidental" flag byte in the data.</p>
                <p>At the receiving end data link layer removes the escape byte before the data are given to the network layer.</p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Data frames can contain an arbitrary number of bits and allows character codes with an arbitrary number of bits per character. Where each frame begins and ends with a special bit pattern, 01111110 (flag byte).
              </p>

              <HighlightBox title="How it works:" color="blue">
                <p className="mb-2"><strong>Sender:</strong> Whenever the senders data link layer encounters five consecutive 1s in the data, it automatically stuffs a 0 bit into the outgoing bit stream.</p>
                <p className="mb-2"><strong>Receiver:</strong> When the receiver sees five consecutive incoming 1 bits, followed by a 0 bit, it automatically destuffs the 0 bit.</p>
                <p>Just as byte stuffing is completely transparent to the network layer in both computers, so is bit stuffing.</p>
              </HighlightBox>

              <HighlightBox title="Example:" color="green">
                <p>If the user data contain the flag pattern, 01111110, this flag is transmitted as 011111010 but stored in the receiver's memory as 01111110.</p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700">
                In such cases normally, a 1 bit is a high-low pair and a 0 bit is a low-high pair. The combinations of low-low and high-high which are not used for data may be used for marking frame boundaries.
              </p>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <HighlightBox title="What is an Error?" color="blue">
                <p>Error is a condition when the output information does not match with the input information. During transmission, digital signals suffer from noise that can introduce errors in the binary bits travelling from one system to other. That means a 0 bit may change to 1 or a 1 bit may change to 0.</p>
              </HighlightBox>

              <HighlightBox title="Error Detection Methods:" color="green">
                <ul className="list-disc ml-5">
                  <li>Parity Check</li>
                  <li>Check Sum</li>
              ...
              <HighlightBox title="Error Correction:" color="yellow">
                <p>Error Correction is the detection of errors and reconstruction of the original, error-free data.</p>
                <p className="mt-2"><strong>Method:</strong> Hamming Code (Error Detection and Correction both)</p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                A additional bit, added with original block to perform checking of data. A parity bit, or check bit is a bit added to the end of a string of binary code that indicates where the number of bits in the string with the value one is even or odd. Parity bits are used as the simplest form of error detecting code.
              </p>

              <HighlightBox title="Types:" color="blue">
                <ul className="list-disc ml-5">
                  <li><strong>Even Parity:</strong> Example: 01100000 becomes 011000001</li>
                  <li><strong>Odd Parity:</strong> Example: 1101000 becomes 11101000</li>
                </ul>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700">
                The sender and receiver agree on how long are the blocks. The sender adds the block using one's complement arithmetic and creates an additional block with the same size.
              </p>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Given by R.W Hamming. Easy to implement. 7 bit hamming code is used commonly.
              </p>
              ...
              <HighlightBox title="How it works:" color="green">
                <ol className="list-decimal ml-5 space-y-2">
                  <li>Write the bit positions starting from 1 in binary form (1, 10, 11, 100, etc).</li>
                  <li>All the bit positions that are a power of 2 are marked as parity bits (1, 2, 4, 8, etc).</li>
                  <li>All the other bit positions are marked as data bits.</li>
                  <li>Each data bit is included in a unique set of parity bits, as determined by its bit position in binary form:
                    <ul className="list-disc ml-5 mt-1">
                      <li>Parity bit 1 covers all the bits positions whose binary representation includes a 1 in the least significant position (1, 3, 5, 7, 9, 11, etc).</li>
                      <li>Parity bit 2 covers all the bits positions whose binary representation includes a 1 in the second position from the least significant bit (2, 3, 6, 7, 10, 11, etc).</li>
                      <li>Parity bit 4 covers all the bits positions whose binary representation includes a 1 in the third position from the least significant bit (4–7, 12–15, 20–23, etc).</li>
                    </ul>
                  </li>
                  <li>Since we check for even parity set a parity bit to 1 if the total number of ones in the positions it checks is odd.</li>
                  <li>Set a parity bit to 0 if the total number of ones in the positions it checks is even.</li>
                </ol>
              </HighlightBox>

              <HighlightBox title="Example:" color="yellow">
                <p><strong>Data:</strong> 1101</p>
                <p><strong>Hamming Code Structure:</strong> P1 P2 D3 P4 D5 D6 D7</p>
              </HighlightBox>
            </SectionCard>
          </div>
        )}
        ...
        {activeSection === "transport" && (
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mt-3">
                Services are identified at this layer with the help of Port
                Numbers. The major protocols which take care of data
                transportation at Transport layer are TCP and UDP.
              </p>
            </SectionCard>
                ...
                <table className="w-full text-xs sm:text-sm border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-2">
                        Reliable communication (with ACKs)
                      </td>
                      <td className="border border-gray-300 p-2">
                        Unreliable communication (no ACKs)
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-2 font-semibold">
            ...
            <SectionCard>
              ...
              <HighlightBox title="Multiplexing:" color="blue">
                <p>
                  The process of combining multiple data signals (either
                  analogue or digital) into one composite signal for
                  transmission over a shared medium (such as a cable, fiber, or
                  wireless channel).
                </p>
              </HighlightBox>
              ...
              <HighlightBox title="De-multiplexing:" color="green">
                <p>
                  The reverse process of multiplexing — it separates the
                  combined (multiplexed) signal back into the original
                  individual signals at the receiving end.
                </p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700">
                The process of breaking down large data into smaller segments
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700">
                Mechanism to control the rate of data transmission between
                sender and receiver to prevent the receiver from being
                overwhelmed.
              </p>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                TCP is one of the original protocols designed in the TCP/IP
                suite and hence the name of the model.
              </p>

              <Subsection title="🤝 Connection Establishment - Three-Way Handshake">
                <p className="mb-2">
                  TCP uses a process called three-way handshake to establish a
                  connection or virtual-circuit with the destination. The
                  three-way handshake uses the SYN and ACK flags in the Code
                  Bits section of the header. This process is necessary to
                  initialize the sequence and acknowledgement number fields.
                </p>

                <HighlightBox title="Three Steps:" color="blue">
                  <ol className="list-decimal ml-5 space-y-2">
                    <li>
                      <strong>Step 1 - SYN:</strong>
                      <ul className="list-disc ml-5 mt-1">
                        <li>
            ...
            <SectionCard>
              ...
              <HighlightBox color="blue">
                <ul className="list-disc ml-5 space-y-2">
                  <li>
                    The only thing common between TCP and UDP is that they use
                    port numbers to transport traffic
                  </li>
                  <li>
                  ...
                  <li>
                    TCP has a higher overhead with a larger header and
                    acknowledgements
                  </li>
                  <li>
                    The source also holds data till it receives acknowledgement
                    in TCP
                  </li>
                </ul>
              </HighlightBox>
              ...
              <HighlightBox title="When to Use UDP:" color="green">
                <p>
                  Some applications, especially those that deal with voice and
                  video, require fast transport and take care of the reliability
          ...
          <div>
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                ...
                <li>
                  Restarts sessions that are disrupted or idle for a long period
                  of time
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-1 text-xs sm:text-sm text-gray-700">
                <li>
                  <strong>Translation data:</strong> Converts data formats
                  between different systems
                </li>
                <li>
                  <strong>Compression data:</strong> Reduces data size for
                  efficient transmission
                </li>
                <li>
                  <strong>Encrypt data:</strong> Secures data through encryption
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                The application layer is closest to the end user. Network
              ...
              <HighlightBox color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Acts as interface between the applications and the
                    underlying network
                  </li>
                  <li>
                    Application layer protocols help exchange data between
                    programs running on the source and destination hosts
                  </li>
                  <li>
                    The TCP/IP application layer performs the functions of the
                    upper three layers of the OSI model
                  </li>
                  <li>
                    <strong>Common protocols:</strong> HTTP, FTP, TFTP, DNS,
                    SMTP
                  </li>
                </ul>
              </HighlightBox>
            ...
            <SectionCard>
              ...
              <Subsection title="🌐 What is DNS?">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Larger corporations also use DNS to manage their own company
                    internet
                  </li>
                  <li>
                    Home networks use DNS when accessing the Internet but do not
                    use it for managing the names of home computers
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="📊 Domain Name System Structure">
                <p className="mb-2">
                  Alternatively referred to as a namespace, a domain namespace
                  is a name service provided by the Internet for Transmission
                  Control Protocol networks/Internet Protocol (TCP/IP).
                </p>
                <p className="mb-2">
                ...
                <p>
                  Hierarchy of domain naming on the internet from top-level
                  domains (TLD) down to subdomains.
                </p>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ...
                system with unique addresses. In the Internet, the address
                consists of two parts: a local part and a domain name, separated
                by @ sign.
              </p>
              ...
              <HighlightBox title="Email Address Structure:" color="blue">
                ...
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Local Part:</strong> Address of the mailbox on the
                    mail server
                  </li>
                  <li>
                    <strong>Domain Name:</strong> The domain name of the mail
                    server
                  </li>
                </ul>
              </HighlightBox>
              ...
              <Subsection title="📧 Email Address Components">
                ...
                <p className="mb-2">
                  Defines the name of a special file called the e-user mailbox,
                  where all the mail received for a user is stored for retrieval
                  by the message access agent.
                </p>
                ...
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    ...
                    and send e-mail (mail servers)
                  </li>
                  <li>
                    The domain name assigned to each mail exchanger comes from
                    the DNS database or is a logical name (e.g., the name of the
                    organization)
                  </li>
                </ul>
              </Subsection>
            ...
            <SectionCard>
              ...
              <Subsection title="📤 SMTP (Simple Mail Transfer Protocol)">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Mail servers and mail transfer agents use SMTP to both send
              ...
              <Subsection title="📥 POP3 (Post Office Protocol Version 3)">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Application layer protocol used by email clients to retrieve
                    email messages from mail servers over TCP/IP network
                  </li>
                  <li>
                    Very simple protocol to implement but that limits its usage
                  </li>
              ...
              <Subsection title="📬 IMAP (Internet Message Access Protocol)">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Enables email clients to retrieve email messages from mail
                    servers over TCP/IP connection
                  </li>
                  <li>
                    Designed to retrieve messages from multiple mail servers
                  </li>
                  <li>
                    All modern email clients and servers like Gmail, Outlook,
                    and Yahoo Mail support IMAP or POP3 protocol
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="📁 FTP (File Transfer Protocol)">
                ...
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    ...
                    dropped (if protocol is configured appropriately)
                  </li>
                  <li>
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                ...
                <li>
                  <strong>Hypertext:</strong> A word or group of words linking
                  to another web page of the same or different website
                </li>
                <li>
                  Evolution from ARPANET to WWW was possible due to many new
                  achievements by researchers and computer scientists all over
                  the world
                </li>
              </ul>
            </SectionCard>
            ...
            {/* 
            <SectionCard>
              <h2 className="sm:text-2xl font-bold text-gray-800 mb-4 pb-2 border-b-2 border-blue-600">
            ...
            <SectionCard>
              ...
              <Subsection title="3️⃣ Acknowledged Connection-Oriented">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>Error control</li>
                  <li>
                    <strong>Protocols:</strong> HTTP, FTP, SMTP
                  </li>
                </ul>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700">
                It refers to a set of procedures used to restrict the amount of
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Network is responsible for transmission of data from one device
                to another device. The end to end transfer of data from a
                transmitting application to a receiving application involves
                many steps, each subject to error.
              </p>
              <p className="text-xs sm:text-sm text-gray-700">
                With the error control process, we can be confident that the
                transmitted and received data are identical. Data can be
                corrupted during transmission. For reliable communication,
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Translation of physical layer's raw bits into a larger aggregate
                (or) discrete units called frames.
              </p>

              <HighlightBox title="Two Types of Frames:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Fixed Length:</strong> All frames have the same size
                  </li>
                  <li>
                    <strong>Variable Length:</strong> Frames can have different
                    sizes
                  </li>
                </ul>
              </HighlightBox>
              ...
              <HighlightBox title="Frame Structure:" color="purple">
                ...
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Header:</strong> Frame starting bits, Address of
                    source/destination, Type of data, Quality control
                  </li>
                  <li>
                    <strong>Payload:</strong> Actual data
                  </li>
                  <li>
                    <strong>Trailer:</strong> Frame stopping bits, Error
                    detection
                  </li>
                </ul>
              </HighlightBox>
              ...
              <ExampleBox>
                <p className="font-semibold mb-2">
                  Fixed Length Frame Example:
                </p>
                <p>
                  If each frame is 10 bits (header) + 20 bits (data) + 10 bits
                  (trailer) = 40 bits total
                </p>
            ...
            <SectionCard>
              ...
              <Subsection title="1️⃣ Character Count">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    The Data Link Layer at the destination looks at the
                    character count and decides the end of the frame
                  </li>
                  <li>
                    <strong>Drawback:</strong> If any count is garbled by a
                    transmission error, the destination is unable to decide the
                    frames
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="2️⃣ Flag Byte with Byte Stuffing">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    A serious problem occurs when binary data itself contains
                    flag byte's bit pattern
                  </li>
                  <li>
                    Solution: Sender's data link layer inserts a special escape
                    byte (ESC) just before each "accidental" flag byte in the
                    data
                  </li>
                  <li>
                    At receiving end, data link layer removes the escape byte
              ...
              <Subsection title="3️⃣ Bit Stuffing">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Allows character codes with an arbitrary number of bits per
                    character
                  </li>
                  <li>
                  ...
                  <li>
                    Whenever sender's data link layer encounters five
                    consecutive 1s in the data, it automatically stuffs a 0 bit
                    into the outgoing bit stream
                  </li>
                  <li>
                    When receiver sees five consecutive incoming 1 bits followed
                    by a 0 bit, it automatically destuffs the 0 bit
                  </li>
              ...
              <Subsection title="4️⃣ Physical Layer Coding Violations">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Applicable to networks where encoding on physical medium
                    contains redundancy
                  </li>
                  <li>
                  ...
                  <li>
                    Combinations of low-low and high-high (not used for data)
            ...
            <SectionCard>
              ...
              <HighlightBox title="What is an Error?" color="red">
                ...
                <p>
                  ...
                  can introduce errors in the binary bits traveling from one
                  system to other. That means a 0 bit may change to 1 or a 1 bit
                  may change to 0.
                </p>
              </HighlightBox>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                An additional bit, added with original block to perform checking
                of data. A parity bit, or check bit is a bit added to the end of
                a string of binary code that indicates whether the number of
                bits in the string with the value one is even or odd.
              </p>

              <HighlightBox title="Types of Parity:" color="blue">
                <p className="mb-2">
                  <strong>Even Parity:</strong> Total number of 1s (including
                  parity bit) should be even
                </p>
                <p>
                  <strong>Odd Parity:</strong> Total number of 1s (including
              ...
              <ExampleBox>
                ...
                <p className="mb-1">
                  Data: 0110000 → Even Parity: 01100000 (adding 0)
                </p>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                To compute the checksum, the sender treats the data unit as a
                sequence of a certain number of blocks, all with the same number
                of bits. The sender and receiver agree on how long are the
                blocks. The sender adds the blocks using one's complement
                arithmetic and creates an additional block with the same size.
              </p>
              <ExampleBox>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Given by R.W Hamming. Easy to implement. 7-bit hamming code is
                commonly used.
              </p>
              ...
              <HighlightBox title="Components:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Data bits:</strong> Original information bits
                  </li>
                  <li>
                    <strong>Parity bits:</strong> Additional bits for error
              ...
              <Subsection title="📝 Hamming Code Algorithm">
                <ol className="list-decimal ml-5 space-y-2">
                  <li>
                    Write the bit positions starting from 1 in binary form (1,
                    10, 11, 100, etc)
                  </li>
                  <li>
                    All bit positions that are a power of 2 are marked as parity
                    bits (1, 2, 4, 8, etc)
                  </li>
                  ...
                  <li>
                    ...
                    <ul className="list-disc ml-5 mt-1 space-y-1">
                      <li>
                        Parity bit 1 covers all bits whose binary representation
                        includes a 1 in the least significant position (1, 3, 5,
                        7, 9, 11, etc)
                      </li>
                      <li>
                        Parity bit 2 covers all bits whose binary representation
                        includes a 1 in the second position (2, 3, 6, 7, 10, 11,
                        etc)
                      </li>
                      <li>
                        Parity bit 4 covers all bits whose binary representation
                        includes a 1 in the third position (4–7, 12–15, 20–23,
                        etc)
                      </li>
                    </ul>
                  </li>
                  <li>
                    For even parity: Set a parity bit to 1 if the total number
                    of ones in the positions it checks is odd
                  </li>
                  <li>
                    Set a parity bit to 0 if the total number of ones in the
              ...
              <HighlightBox title="Practice Problem:" color="yellow">
                <p>
                  If the 7-bit hamming code word received is 1011011. Assuming
                  even parity, state whether the received code word is correct
                  or wrong. If wrong, locate the bit having error.
                </p>
              </HighlightBox>
            </SectionCard> */}
          </div>
        ...
        {activeSection === "mac" && (
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                In a computer network, multiple devices share the same
                communication medium (cables or wireless signals).
              </p>
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                <li>
                  If devices transmit data at the same time, signals collide →
                  data is lost → retransmissions are required
                </li>
            ...
            <SectionCard>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <HighlightBox title="LLC (Logical Link Control)" color="blue">
                  <ul className="list-disc ml-5 space-y-1">
                    <li>
                      Identifies which network protocol (e.g., IP, ARP, IPv6) is
                ...
                <HighlightBox title="MAC (Medium Access Control)" color="green">
                  <ul className="list-disc ml-5 space-y-1">
                    ...
                    <li>
                      Determines how devices share the medium and avoid
                      collisions
                    </li>
                    <li>
                      Adds information to frames for addressing and error
                      detection
                    </li>
                  </ul>
                </HighlightBox>
            ...
            <SectionCard>
              ...
              <Subsection title="1️⃣ Abstraction of the Physical Layer">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Provides an interface between the Physical Layer and upper
                    layers (LLC and Network Layer)
                  </li>
                  <li>
                    Upper layers don't need to worry about the actual medium
                    (wired or wireless)
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="2️⃣ Frame Encapsulation">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Encapsulates network data into frames suitable for
                    transmission
                  </li>
                  <li>
                    Adds header (source & destination MAC addresses) and trailer
              ...
              <Subsection title="3️⃣ Addressing">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Assigns unique MAC addresses to each device's NIC (Network
                    Interface Card)
                  </li>
                  <li>
                    Determines source and destination addresses for frame
                    delivery
                  </li>
              ...
              <Subsection title="4️⃣ Access Control & Multiple Access Resolution">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Determines which device can use the medium when multiple
                    devices want to transmit
                  </li>
                  <li>
                    Implements multiple access protocols (Random Access:
                    CSMA/CD, CSMA/CA; Controlled Access: Token Passing, Polling)
                  </li>
                  <li>
              ...
              <Subsection title="5️⃣ Collision Handling & Retransmission">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Initiates retransmission after a random backoff or waiting
                    period
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="6️⃣ Frame Delivery">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Works with switches and access points to forward frames
                    accurately
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="7️⃣ Error Detection">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Generates Frame Check Sequence (FCS) using CRC (Cyclic
                    Redundancy Check)
                  </li>
                  <li>
                    Detects corrupted frames and prevents them from reaching
                    upper layers
                  </li>
                </ul>
              </Subsection>
            ...
            <SectionCard>
              ...
              <HighlightBox title="Three Categories:" color="blue">
                <ol className="list-decimal ml-5 space-y-1">
                  <li>
                    <strong>Random Access Protocol:</strong> ALOHA, CSMA,
                    CSMA/CD, CSMA/CA
                  </li>
                  <li>
                    <strong>Controlled Access Protocol:</strong> Reservation,
                    Polling, Token Passing
                  </li>
                  <li>
                    <strong>Channelization Protocol:</strong> FDMA, TDMA, CDMA
                  </li>
                </ol>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                In random access methods, all stations are treated equally — no
                one has control over the channel. Any device can attempt to
                transmit data at any time, without permission from others.
              </p>
              ...
              <HighlightBox title="Key Characteristics:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Collisions can occur when multiple stations transmit
                    simultaneously
                  </li>
                  <li>
                    Protocols define how stations detect or avoid collisions and
                    retry sending
                  </li>
                </ul>
              </HighlightBox>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                ALOHA was the first random access protocol, developed at the
                University of Hawaii in the 1970s for wireless communication. It
                laid the foundation for modern wireless and shared medium access
                methods.
              </p>
              ...
              <Subsection title="📡 Pure ALOHA">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    If acknowledgment is not received, retransmit after random
                    time
                  </li>
                </ul>
              </Subsection>
              ...
              <HighlightBox title="Applications:" color="green">
                <p>
                  Still relevant in low-power wireless networks like LoRa,
                  LPWAN, and some satellite links
                </p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="1️⃣ 1-Persistent CSMA">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    If busy, continuously sense (listen) until it becomes idle
                    and send immediately
                  </li>
                  <li>
                    High risk of collision, especially when multiple stations
                    are waiting
                  </li>
                  <li>
                    In case of collision, sender waits for random period and
                    attempts to transmit again (with probability = 1)
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="2️⃣ Non-Persistent CSMA">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    If busy, station waits random time and then senses the
                    carrier again
                  </li>
                  <li>
                    <strong>Advantage:</strong> Reduces the chances of collision
                  </li>
                  <li>
                    <strong>Disadvantage:</strong> Reduces the efficiency of the
                    network
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="3️⃣ P-Persistent CSMA">
                <p className="mb-2">
                  Used if the channel has time slots with slot duration equal to
                  or greater than the maximum propagation time.
                </p>
                <ol className="list-decimal ml-5 space-y-1">
                  <li>
                    After finding the line idle:
                    <ul className="list-disc ml-5 mt-1">
                      <li>With probability p, the station sends its frame</li>
                      <li>
                        With probability q = 1-p, wait for next time slot and
                        check again
                      </li>
                    </ul>
                  </li>
                  <li>
                    If line is busy, acts as though collision occurred and uses
                    backoff procedure
                  </li>
                </ol>
                <p className="mt-2">
                  <strong>Applications:</strong> Used in CSMA/CA systems
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                CSMA/CD protocol can be considered as a refinement over the CSMA
                scheme. The nodes continue to monitor the channel while
                transmitting a packet and immediately cease transmission when
                collision is detected. This scheme is known as
                Listen-While-Talk.
              </p>
              ...
              <Subsection title="📋 Two Rules">
                <ol className="list-decimal ml-5 space-y-2">
                  <li>
                    If collision is detected during transmission, the station
                    will immediately cease/abort the transmission and send a
                    Jamming signal (for a brief duration) to enforce the
                    collision to all other stations
                  </li>
                  <li>
                    After transmitting the jamming signal, the station waits for
                    a random amount of time and then transmission is resumed
                  </li>
                </ol>
              </Subsection>
              ...
              <HighlightBox title="Binary Exponential Backoff:" color="purple">
                <p className="mb-2">
                  ...
                  repeated collisions, but after each collision, the mean value
                  of random delay is doubled.
                </p>
                <p>
                  <strong>Note:</strong> Jamming signal is a 48-bit jamming
                  sequence by station to indicate collision to other stations
                  around the network.
                </p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                CSMA/CA is used in wireless networks. In wireless networks most
                of the energy is lost due to transmission. So collisions can add
                5-10% additional energy which can't be well detected. So
                collisions are avoided using three CSMA/CA strategies:
              </p>

              <ul className="list-disc ml-5 space-y-1 text-xs sm:text-sm text-gray-700">
                <li>
                  <strong>Inter-Frame Space:</strong> Waiting period between
                  frames
                </li>
                <li>
                  <strong>Contention Window:</strong> Random backoff time before
                  transmission
                </li>
                <li>
                  <strong>Acknowledgments:</strong> Confirms successful
                  reception
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="2️⃣ Polling">
                <p>
                  Primary station polls secondary stations to determine which
                  has data to send. Uses Select and Poll functions to have
                  communication between primary and secondary stations.
                </p>
              </Subsection>

              <Subsection title="3️⃣ Token Passing">
                <p>
                  A special data packet called "token" circulates among devices.
                  Only the device that holds the token is allowed to send data.
                  Once finished, it passes the token to the next device.
                </p>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Token Passing is a deterministic network access method where a
                special data packet called a "token" circulates among the
                devices (or nodes) on the network.
              </p>
              ...
              <HighlightBox title="How It Works:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Once the device finishes transmission, it passes the token
                    to the next device
                  </li>
              ...
              <HighlightBox
                title="FDDI Token Ring Frame Format:"
                color="purple"
              >
            ...
            <SectionCard>
              ...
              <Subsection title="1️⃣ Frequency-Division Multiple Access (FDMA)">
                <p>
                  Bandwidth divided into frequency bands, each assigned to a
                  different user
                </p>
              </Subsection>
              ...
              <Subsection title="2️⃣ Time-Division Multiple Access (TDMA)">
                <p>
                  Bandwidth divided into time slots, each assigned to a
                  different user
                </p>
              </Subsection>
              ...
              <Subsection title="3️⃣ Code-Division Multiple Access (CDMA)">
                <p>
                  Users share the same frequency band but use different codes to
                  separate their data
                </p>
              </Subsection>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                In computer networking, Ethernet is a technology for connecting
                devices in a local area network (LAN). It defines how data is
                transmitted over a wired network and is one of the most commonly
                used LAN technologies in the world.
              </p>

              <HighlightBox title="Key Characteristics:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Medium:</strong> Usually uses twisted pair cables
                    (Cat5e, Cat6) and sometimes fiber optics
                  </li>
                  <li>
                    <strong>Speed:</strong> Common speeds include 100 Mbps, 1
                    Gbps (Gigabit Ethernet), 10 Gbps, etc.
                  </li>
                  <li>
                    <strong>Standard:</strong> Defined by the IEEE 802.3
                    standard
                  </li>
                  <li>
                    <strong>Data Transmission:</strong> Uses frames to transmit
                    data between devices
                  </li>
                  <li>
                    <strong>Topology:</strong> Typically uses star or bus
                    topology
                  </li>
                  <li>
                    <strong>Switch/Hub:</strong> Devices usually connected
                    through a switch (or older hubs)
                  </li>
                </ul>
              </HighlightBox>
              ...
              <ExampleBox>
                ...
                <p className="mt-2">
                  If you connect all of them with Ethernet cables and a switch,
                  they can communicate quickly and reliably within the same
                  network.
                </p>
              </ExampleBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="3️⃣ Switch or Hub">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Connects all devices and manages data traffic efficiently
                  </li>
              ...
              <Subsection title="4️⃣ Router (Optional but Common)">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Often includes a built-in switch with multiple Ethernet
                    ports
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="5️⃣ Power Supply">
                <p>
                  All devices like routers and switches need power. Make sure
                  power outlets are available where needed.
                </p>
              </Subsection>
            ...
            <SectionCard>
              ...
              <Subsection title="⚡ Fast Ethernet">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Based on proven CSMA/CD Media Access Control (MAC) protocol
                  </li>
                  <li>Uses existing 10BaseT cabling</li>
                  <li>
                    Data can move from 10 Mbps to 100 Mbps without protocol
                    translation
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="🚀 Gigabit Ethernet">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    All four pairs of twisted wires used to achieve high data
                    transfer rates
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="⚡ 10 Gigabit Ethernet">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Latest generation delivering 10 Gbit/s (10,000 Mbit/s)
                  </li>
                  <li>Uses fiber optic or twisted pair cable</li>
                  <li>
                    10GBASE-LX4, 10GBASE-ER, and 10GBASE-SR based on optical
                    fiber can bridge up to 10,000 m (6.2 miles)
                  </li>
                  <li>
                    Twisted pair solution requires high quality cable (Cat-6a or
                    Cat-7)
                  </li>
              ...
              <Subsection title="🔷 40 Gigabit & 100 Gigabit Ethernet">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Speed:</strong> 40 Gbps and 100 Gbps
                  </li>
                  <li>
                    <strong>Cable Type:</strong> Primarily fiber optic
                    (multimode & single-mode), limited use of Cat8 for short
                    distances
                  </li>
                  <li>
                    <strong>Usage:</strong> Enterprise networks, data centers &
                    cloud providers, ISP backbones & telecom infrastructure
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="💎 Terabit Ethernet">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Next-generation standard aiming for 400 Gbps, 1 Tbps, and
                    beyond
                  </li>
                  <li>
                    <strong>Current deployments:</strong> 400 Gigabit Ethernet
                    (400GbE)
                  </li>
                  <li>
                    <strong>Future goal:</strong> 1 Terabit per second (Tbps)
                    and higher
                  </li>
                  <li>
                    <strong>Cable Type:</strong> Primarily fiber optic with
                    advanced multiplexing
                  </li>
                  <li>
                    <strong>Usage:</strong> High-performance computing (HPC),
                    large-scale cloud infrastructures, next-gen ISP backbones,
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Different variants of Ethernet technologies are designated
                according to the type and diameter of the cables used:
              </p>

              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                <li>
                  <strong>10Base2:</strong> Thin coaxial cable (thin Ethernet)
                </li>
                <li>
                  <strong>10Base5:</strong> Thick coaxial cable (thick Ethernet)
                </li>
                <li>
                  <strong>10Base-T:</strong> Twisted-pair cable, speed around 10
                  Mbps
                </li>
                <li>
                  <strong>100Base-FX:</strong> Multimode fiber optic, achieves
                  100 Mbps
                </li>
                <li>
                  <strong>100Base-TX:</strong> Similar to 10Base-T, but 10 times
                  greater speed (100 Mbps)
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <Subsection title="📱 Bluetooth Topology">
                ...
                <p className="mb-2">
                  <strong>Piconet:</strong> A small ad hoc network of 8 stations
                </p>
                <ul className="list-disc ml-5 space-y-1">
            ...
            <SectionCard>
              ...
              <Subsection title="🔄 Hub">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Collision domain of all hosts connected through Hub remains
                    one
                  </li>
                  <li>
                    No intelligence to find out best path for data packets
                  </li>
              ...
              <Subsection title="🌉 Bridge">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    A repeater with added functionality of filtering content by
              ...
              <Subsection title="🔀 Switch">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Very efficient - does not forward packets that have errors
                  </li>
                  <li>
              ...
              <Subsection title="🛣️ Router">
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Makes decisions on routing the data packets based on routing
                    table
                  </li>
                  <li>
                    Divides broadcast domains of hosts connected through it
                  </li>
                </ul>
              </Subsection>
            </SectionCard>
        ...
        {activeSection === "network" && (
          <div>
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                The network layer is responsible for routing packets from the
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                The routing algorithm is the piece of software that decides
                where a packet goes next (e.g., which output line, or which node
              ...
              <HighlightBox color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    For connectionless networks, the routing decision is made
                    for each datagram
                  </li>
                  <li>
                    For connection-oriented networks, the decision is made once,
              ...
              <p className="text-xs sm:text-sm text-gray-700 mt-3 mb-3">
                There are many nodes in a computer network. Routing is the
                process of forwarding a packet from source node to the
                destination and it is important to find the best path to send
                the packets. It can be found using a routing algorithm.
              </p>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                <li>
                  <strong>Correctness:</strong> No deadlocks, unreachable states
                </li>
                <li>
                  <strong>Simplicity:</strong> Fast handling of packets, less
                  failures
                </li>
                <li>
                  <strong>Robustness:</strong> Dealing with failures, changes of
                  the topology and of the traffic
                </li>
                <li>
                  <strong>Stability:</strong> Should be stable under all
                  possible circumstances
                </li>
                <li>
                  <strong>Optimality:</strong> Should be optimal in terms of
            ...
            <SectionCard>
              ...
              <Subsection title="🔄 Dynamic Routing Algorithms">
                ...
                <ul className="list-disc ml-5 space-y-1">
                  ...
                  <li>
                    Change routing decisions based on topology and network
                    traffic
                  </li>
                  <li>
                  ...
                  <li>
                    Main optimization parameters: hops, distance, and estimated
                    transit time
                  </li>
                </ul>
              </Subsection>
              ...
              <Subsection title="📌 Static Routing Algorithms">
                ...
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    Routing information downloads to routers when booting up the
                    network
                  </li>
                  <li>
                    Do not take routing decisions based on network topology or
                    traffic
                  </li>
                </ul>
              </Subsection>
              ...
              <HighlightBox title="Algorithm Categories:" color="blue">
                <ul className="list-disc ml-5 space-y-1">
                  <li>
                    <strong>Static:</strong> Shortest path routing algorithm
                  </li>
                  <li>
                    <strong>Dynamic:</strong> Link state routing algorithm
                  </li>
            ...
            <SectionCard>
              ...
              <HighlightBox title="Practice Problems:" color="yellow">
                <p className="mb-2">
                  Try solving the shortest path for these graphs:
                </p>
                <p className="mb-2">
                  <strong>Example 1:</strong> Undirected graph with nodes 0-8
                  and various edge weights
                </p>
                <p>
                  <strong>Example 2:</strong> Directed graph with nodes A-E and
            ...
            <SectionCard>
              ...
              <HighlightBox
                title="Steps to Create Forwarding Table:"
                color="blue"
              >
                <ol className="list-decimal ml-5 space-y-1">
              ...
              <HighlightBox title="Exercise:" color="yellow">
                <p>
                  Create forwarding table using link state routing algorithm for
                  given topology with costs.
                </p>
              </HighlightBox>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <ul className="list-disc ml-5 space-y-2 text-xs sm:text-sm text-gray-700">
                ...
                <li>
                  Each router has only the information about the routers in its
                  own region
                </li>
                <li>Has no information about routers in other regions</li>
                <li>
                  Routers only contain the record of their immediate neighbors
                  in the table
                </li>
              </ul>
            </SectionCard>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Host needs to send messages to many or all other hosts in a
                network. Sending a packet to all destinations simultaneously is
                called broadcasting.
              </p>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                Sending a message to a group of hosts out of a large number of
                computers without broadcasting.
              </p>

              <HighlightBox color="blue">
                <p className="mb-2">
                  <strong>Spanning tree:</strong> Tree containing all the
                  vertices and some/all edges of a tree without cycles
                </p>
            ...
            <SectionCard>
              ...
              <p className="text-xs sm:text-sm text-gray-700 mb-3">
                When one part of the subnet (e.g. one or more routers in an
                area) becomes overloaded, congestion results.
              </p>
            ...
            <SectionCard>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <HighlightBox
                  title="🔓 Open-Loop Congestion Control"
                  color="blue"
                >
                  <p className="mb-2">
                    Prevention - policies applied before congestion happens
                  </p>
                  <p>
                ...
                <HighlightBox
                  title="🔒 Closed-Loop Congestion Control"
                  color="green"
                >
                  <p className="mb-2">
                    Removal - handles congestion after it occurs
                  </p>
