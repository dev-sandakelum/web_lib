...
export const IsLesson07Dataset: Dataset = {
  ...
  content: `
Topic: IT Strategic Planning, Systems Development Life Cycle, and Computer Crime Prevention

Objectives:
• Understand IT Strategic Planning and its role in achieving business goals
• Identify methods for selecting IT projects
• Understand the Systems Development Life Cycle (SDLC) and its phases
• Learn about alternative development approaches (Prototyping, RAD, JAD)
• Recognize factors affecting systems development success
• Identify types of computer-related waste, mistakes, and crimes
• Learn prevention strategies for computer-related problems
