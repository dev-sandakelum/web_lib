...
export const networksLesson03Dataset: Dataset = {
  ...
  content: `
Topic: IP Addresses, IPv4, Classful Addressing, Subnet Masks, and CIDR

Objectives:
• Understand what IP addresses are and their purpose
• Learn IPv4 address structure and notation
• Understand classful addressing and IP address classes
• Identify network ID and host ID in IP addresses
• Learn about subnet masks and their purpose
• Understand CIDR (Classless Inter-Domain Routing) notation
...
• The address space in a protocol is 2 raised to N.
• The address space in IPv4 is 2 raised to 32 equals 4,294,967,296 addresses.
...
• A subnet mask distinguishes which portion of the address identifies the network and which portion of the address identifies the node.
...
• CIDR notation is written as IP_address/prefix_length.
