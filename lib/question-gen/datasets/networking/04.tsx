...
export const networksLesson04Dataset: Dataset = {
  ...
  content: `
Topic: Physical Layer - Theoretical Basis for Data Communication and Transmission Media

Objectives:
• Understand Fourier Analysis and its application to data communication
• Learn about Bandwidth-Limited Signals and channel capacity
• Calculate Maximum Data Rate using Nyquist and Shannon theorems
• Identify and compare different types of Transmission Media
• Understand Guided Media: Twisted Pair, Coaxial, and Fiber Optic cables
• Learn about Unguided Media and wireless transmission types
• Explore Radio, Microwave, and Infrared transmission characteristics
...
**Example:** If H = 3 kHz and V = 2, maximum data rate will be 6000 bps.
...
• Unshielded Twisted Pair cables are very cheap and easy to install.
