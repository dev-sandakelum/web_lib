...
export const networksLesson02Dataset: Dataset = {
  ...
  content: `
Topic: Network Architecture, OSI Reference Model, and TCP/IP Reference Model

Objectives:
• Understand network architecture types (Client-Server and Peer-to-Peer)
• Learn the OSI Reference Model and its seven layers
• Understand the TCP/IP Reference Model and its four layers
