...
export const networksLesson10Dataset: Dataset = {
  ...
  content: `
Topic: Application, Presentation, and Session Layers

Objectives:
• Understand the session layer and its functions
• Learn presentation layer functions: translation, compression, encryption
• Master application layer concepts and protocols
• Understand DNS (Domain Name System) and its hierarchy
• Learn HTTP and HTTPS protocols
• Master email systems and protocols (SMTP, POP3, IMAP)
• Understand FTP (File Transfer Protocol)
...
* Defined by RFC 3501
* Enables email clients to retrieve email messages from mail servers over TCP/IP connection
