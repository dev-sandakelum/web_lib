...
Objectives:
• Understand the transport layer and its responsibilities
• Learn major functions of the transport layer
• Master TCP and UDP protocols and their differences
• Understand multiplexing and demultiplexing concepts
• Learn TCP three-way handshake process
• Understand flow control mechanisms
• Learn port numbers and service identification
