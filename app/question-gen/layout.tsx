...
export default function QuestionGenLayout({
  children,
}: Readonly<{
  ...
  return (
    <AppShell className="bg-background text-foreground">
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-2 py-2 sm:px-4 sm:py-3 md:px-6 md:py-4 text-center shadow-sm fixed bottom-16 md:bottom-0 w-full md:left-20 md:w-[calc(100%-5rem)] z-[40]">
