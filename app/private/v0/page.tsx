      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 max-w-md w-full">
          ...
          <p className="text-center text-gray-500 text-xs mt-6">
            ICT1142 - Programming Practicum | Group 01
          </p>
        </div>
      </div>
    );
  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      aboutMe: [
        "Good morning sir. I'm Hasitha Sandakelum, and I served as the Lead Developer for this Digital Voting System project. My journey with this project began with a vision to create a robust, modular architecture that would stand as the foundation for our entire system.",
        "My primary responsibility was establishing the core system architecture. I designed and implemented the file management layer, which serves as the backbone of our data persistence strategy. This includes creating specialized modules like file_handle_register.c, file_handle_session.c, and file_handle_administrator.c that handle all CRUD operations efficiently.",
        "One of my key achievements was developing the fun.h utility library, which provides reusable functions throughout the system. This includes screen management, color formatting, and common operations that enhance both code maintainability and user experience. I also implemented the session management system using cookie-based persistence, allowing users to seamlessly resume their sessions.",
        "Working on the registration module was particularly challenging and rewarding. I implemented multi-stage NIC validation, age verification, and duplicate prevention mechanisms. The modular design pattern I established allowed my teammates to develop their features independently while ensuring smooth integration.",
        "Throughout this 11-week journey, I wrote over 2,200 lines of code across 11 files, made 42 commits, and developed 57+ functions. But beyond the numbers, I'm most proud of creating an architecture that promotes code reusability, maintainability, and scalability. This project taught me the importance of planning before coding and the value of comprehensive testing in delivering quality software.",
      ],
    },
    {
      id: "thisagi",
      ...
      aboutMe: [
        "Good morning sir. I'm Thisagi Omethra, and I had the privilege of serving as both Team Leader and the developer of our authentication system. Leading this team of talented developers while contributing technically was an enriching experience that taught me valuable lessons in both leadership and software development.",
        "As Team Leader, I coordinated our weekly meetings, managed our Git workflow, and ensured that all team members were progressing smoothly on their respective modules. I established coding standards that maintained consistency across our codebase and facilitated regular code reviews to ensure quality. Beyond administrative duties, I resolved integration conflicts and kept our project on schedule throughout the 11-week development period.",
        "On the technical side, I developed the complete authentication and login system. This includes the login_by_pass function that validates user credentials against our database, the session management system that stores user information for automatic login, and the set_user function that maintains global state throughout the application. I implemented both password-based and session-based authentication flows.",
        "One of the interesting challenges I faced was implementing session persistence. When users close and reopen the program, the system automatically logs them in using the saved NIC from login_save.txt. This required careful file handling and error management to ensure reliability. I also designed the cookie notification system to inform users about data storage practices.",
        "Working as Team Leader taught me that successful software projects require both technical excellence and effective communication. Balancing leadership responsibilities with hands-on development gave me a holistic understanding of project management. I'm proud that our team delivered a fully functional system with 100% test pass rate, and I'm grateful for the collaboration and dedication of my teammates.",
      ],
      questions: [
        {
    ...
    },
    {
      ...
      aboutMe: [
        "Good morning sir. I'm Achala Eshan, and I developed the complete voting module for our Digital Voting System. The voting process is the heart of our application, and I'm proud to have created a system that ensures secure, validated, and user-friendly vote casting.",
        "My primary contribution is the vote.c module, which implements the entire voting workflow from start to finish. This includes district selection, party selection, candidate selection, vote validation, and final vote persistence. I designed it as a section-based state machine that guides users through each step systematically, preventing any skipped stages or invalid inputs.",
        "One of the most critical aspects I implemented was vote validation. The system ensures that all three selected candidates belong to the chosen party, prevents duplicate voting by checking user status, and validates that candidate IDs actually exist in our database. I created the is_candidate_in_party function that cross-references each vote against the candidate database to maintain election integrity.",
        "The visual presentation was also important to me. I implemented color-coded party displays where Blue Party appears in blue, Green Alliance in green, and so on. This visual feedback helps users quickly identify parties and candidates. The voted_details_section function provides a clear confirmation screen showing exactly what the user selected before final submission.",
        "Developing this module taught me the importance of data validation and user experience design. I wrote 508 lines of code across 15+ functions, made 21 commits, and tested extensively with various scenarios including cross-party voting attempts and duplicate candidate selection. Seeing the complete voting flow work seamlessly from login through vote confirmation was incredibly satisfying. This project enhanced my understanding of state management and complex user workflows.",
      ],
      questions: [
        {
    ...
    },
    {
      ...
      aboutMe: [
        "Good morning sir. I'm Lakshani Salgadu, and I developed the results and analytics module that brings all the voting data together into meaningful insights. My work transforms raw vote records into comprehensive election statistics that show party performance, candidate popularity, and overall participation metrics.",
        "The core of my contribution is the calculate_results function, which processes the votes.txt file to aggregate all cast votes. Each vote record contains three candidate selections separated by pipe characters, and my algorithm parses these, increments vote counts for each candidate, and maintains accurate totals. This data then feeds into various analytics displays.",
        "I also implemented the load_get_parties function that dynamically builds a list of all participating parties by reading the candidates file. This approach ensures our results display adapts automatically as new parties or candidates are added, without requiring code changes. The function also tracks how many candidates each party has, which is essential for calculating party-level vote totals.",
        "The results display itself was designed for clarity and visual appeal. I created a color-coded ranking system where each party is shown in its representative color, making it immediately clear which party is which. The system also identifies and highlights the most popular candidate and most popular party, providing quick insights into election trends. Users can refresh results in real-time to see updated vote counts.",
        "Throughout development, I wrote 215 lines of code, made 15 commits, and developed 7 key functions. The biggest challenge was ensuring vote counting accuracy while maintaining performance with potentially hundreds of vote records. I'm particularly proud of the statistics section that shows total votes cast, voter participation, and individual candidate performance. This project taught me the importance of data aggregation algorithms and the value of presenting complex information in an accessible, visually clear format.",
      ],
      questions: [
        {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700">
      <div className="max-w-7xl mx-auto bg-white shadow-2xl min-h-screen">
        ...
        {/* Navigation */}
        <nav className="bg-gray-800 p-2 sm:p-3 sticky top-0 z-50 shadow-lg overflow-x-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {overviewContent.features.map((feature, index) => (
                  ...
                  >
                    <span className="text-lg sm:text-2xl text-purple-600 flex-shrink-0">
                      ✓
                    </span>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                {teamMembers.map((member) => (
                  <div
                    key={member.id}
                    className="border-2 border-gray-200 rounded-lg p-4 sm:p-6 hover:border-purple-600 transition-colors cursor-pointer"
                    onClick={() => setActiveSection(member.id)}
                  >
                    ...
                    <p className="text-purple-600 font-semibold mb-1 sm:mb-2">
                      {member.role}
                    </p>
        ...
        {currentMember && activeSection !== "overview" && (
          <div className="p-3 sm:p-4 md:p-8">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-xs sm:text-sm break-all">
                    {currentMember.email}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-bold">
                    {currentMember.contributions.length}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8">
              ...
              <div className="space-y-4">
                {currentMember.aboutMe.map((paragraph, index) => (
                  <p
                    key={index}
        ...
        {currentMember &&
          ...
          currentMember.questions.length > 0 && (
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6">
                Q&A Session
              </h3>
              <div className="space-y-2 sm:space-y-3">
                {currentMember.questions.map((qa, index) => (
                  ...
                  >
                    <button
                      onClick={() =>
                        toggleQuestion(`${currentMember.id}-${index}`)
                      }
